...
define('TEXT_NEW_CUSTOMER', 'We are glad to welcome you as a new customer!');
define('TEXT_NEW_CUSTOMER_INTRODUCTION', 'Creating an account at ' . STORE_NAME . ' is necessary to order something and you will be able to shop faster, be up to date on an orders status, and keep track of the orders you have previously made.');

define('HEADING_RETURNING_CUSTOMER', 'Returning Customer');
define('TEXT_RETURNING_CUSTOMER', 'If you are a returning customer, login here!');
