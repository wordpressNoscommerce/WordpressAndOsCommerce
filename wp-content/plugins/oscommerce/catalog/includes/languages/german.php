<?php
/*
  $Id: german.php,v 1.114 2003/07/09 18:13:39 dgw_ Exp $
...
// labels box text in includes/boxes/categories.php
define('BOX_HEADING_CATEGORIES', 'LABELS');

// artists box text in includes/boxes/manufacturers.php
define('BOX_HEADING_MANUFACTURERS', 'ARTISTS');

// formats box text in includes/boxes/formats.php
define('BOX_HEADING_FORMATS', 'FORMATS');
...
// offer box text - addon to the featured-module
define('BOX_HEADING_OFFER','Offer');
...
define('BOX_HEADING_SHOPPING_CART', 'SHOPPINGBOX');
define('BOX_SHOPPING_CART_EMPTY', '0 items');
define('BOX_SHOPPING_CART_KILL', 'KILLBOX');
define('BOX_EDIT_SHOPPING_CART', 'EDITBOX');
define('BOX_SHOPPING_CART_BUY', 'BUY');
...
define('IMAGE_BUTTON_SUBMIT', 'Submit message');
define('IMAGE_BUTTON_TELL_A_FRIEND', 'Tell a Friend');
define('IMAGE_BUTTON_UPDATE', 'Update');
define('IMAGE_BUTTON_UPDATE_CART', 'Update Cart');
define('IMAGE_BUTTON_WRITE_REVIEW', 'Write Review');
define('IMAGE_DOWNLOAD','Click right to download ');
...
define('TEXT_NEW_IN_SHOP','New in shop');
...
define('BOX_CATALOG_FEATURED_PRODUCTS', 'SPECIALS');
// featured box text in includes/boxes/featured.php
define('BOX_HEADING_FEATURED', 'SPECIALS');
